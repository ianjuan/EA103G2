...
CREATE TABLE EMPLOYEE (
  ...
  EMP_PIC BLOB,
  EMP_MAIL VARCHAR2(60 BYTE),
  CONSTRAINT PK_EMP PRIMARY KEY (EMP_NO)
);

CREATE TABLE CASH (
CASH_NO VARCHAR2(20 BYTE) NOT NULL,
CASH_DATE DATE,
MEM_NO VARCHAR2(20 BYTE),
CASH_INOUT VARCHAR2(20 BYTE),
CASH_TYPE VARCHAR2(20 BYTE),
CASH_AMOUNT NUMBER,
CON_NO VARCHAR2(20 BYTE),
REC_NO VARCHAR2(20 BYTE),
CASH_STATUS NUMBER,
CONSTRAINT CASH_PK PRIMARY KEY (CASH_NO)
);
...
ALTER TABLE TENANT  
MODIFY (TNT_BALANCE DEFAULT 1000000 );
...
(
  HOS_NO      VARCHAR2(20 BYTE) NOT NULL, 
	...
	HOS_BRO     NUMBER(20,0),
	HOS_STATUS  VARCHAR2(30 BYTE)NOT NULL,
	HOS_ADD     VARCHAR2(300 BYTE)NOT NULL, 
	HOS_TYPE    VARCHAR2(30 BYTE)NOT NULL, 
	HOS_FLOOR   VARCHAR2(200 BYTE), 
	HOS_PNUM    NUMBER(6,2)NOT NULL, 
	HOS_DATE    TIMESTAMP (6), 
	HOS_LNG     NUMBER(10,7), 
	HOS_LAT     NUMBER(10,7), 
	HOS_PAT     VARCHAR2(300 BYTE), 
	HOS_ROOM    VARCHAR2(30 BYTE), 
...
CASH_TYPE VARCHAR2(20 BYTE),
CASH_AMOUNT NUMBER,
CON_NO VARCHAR2(20 BYTE) DEFAULT 0,
REC_NO VARCHAR2(20 BYTE) DEFAULT 1,
CASH_STATUS NUMBER DEFAULT 1,
CONSTRAINT CASH_PK PRIMARY KEY (CASH_NO)
);
...
MAXVALUE 100000;
CREATE SEQUENCE SEQ_COL_NO
MAXVALUE 100000;
CREATE SEQUENCE SEQ_CASH_NO
MAXVALUE 100000;
