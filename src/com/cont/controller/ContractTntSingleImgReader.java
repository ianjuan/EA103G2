...
public class ContractTntSingleImgReader extends HttpServlet {

	private static final String GET_LLDHOUSEPIC = "SELECT CON_TNT_SIGN FROM CONTRACT WHERE CON_NO = ?";
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("CON_TNT_SIGN"));
