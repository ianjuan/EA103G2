...
public class LldVO implements java.io.Serializable {
	...
	// -------pocket-------
	private int lld_blance;
	// -------card/bank-------
	private int lld_bank;
	private String lld_bankbrach;
	private String lld_bankacc;
	private long lld_card;
	private int lld_cardsvc;
	...
	public int getLld_blance() {
		return lld_blance;
	}
	public void setLld_blance(int lld_blance) {
		this.lld_blance = lld_blance;
	}
	public int getLld_bank() {
		return lld_bank;
	}
	public void setLld_bank(int lld_bank) {
		this.lld_bank = lld_bank;
	}
	public String getLld_bankbrach() {
		return lld_bankbrach;
	}
	public void setLld_bankbrach(String lld_bankbrach) {
		this.lld_bankbrach = lld_bankbrach;
	}
	...
	public long getLld_card() {
		return lld_card;
	}
	public void setLld_card(long lld_card) {
		this.lld_card = lld_card;
	}
	public int getLld_cardsvc() {
		return lld_cardsvc;
	}
	public void setLld_cardsvc(int lld_cardsvc) {
