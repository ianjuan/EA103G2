...
public class MailService {
	...
	public boolean sendMailRpthc(String LldEmail, String LldName, String LldAcc, String emailVrfLink) {
		...
		subject = "【通知】您提報的房屋評價檢舉成立";
		// 設定信中的內容
		messageText = "日前，您所提交的房屋評價檢舉，經由調查後，給予通過，確認該筆檢舉成立。";
