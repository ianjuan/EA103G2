...
public class TntVO implements java.io.Serializable {
	...
	public int getTnt_blance() {
		return tnt_blance;
	}
	public void setTnt_blance(int tnt_blance) {
		this.tnt_blance = tnt_blance;
	}
	public int getTnt_bank() {
		return tnt_bank;
	}
	public void setTnt_bank(int tnt_bank) {
	...
	public long getTnt_card() {
		return tnt_card;
	}
	public void setTnt_card(long tnt_card) {
