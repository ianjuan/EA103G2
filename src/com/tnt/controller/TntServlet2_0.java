...
public class TntServlet2_0 extends HttpServlet {
...
//				System.out.println(tnt_pwd);
		...
		if ("register0".equals(action)) { // 來自Register.jsp的請求 - ajax_register(formData)
			System.out.println("action: " + action);
			List<String> errorMsgs = new LinkedList<String>();
			req.setAttribute("errorMsgs", errorMsgs);
			try {
...
//				System.out.println("註冊後端驗證: " + errorMsgs);
				...
				String emailVrfLink = req.getScheme() + "://" + req.getServerName() + ":" + req.getServerPort()
						+ req.getContextPath() + "/TntServlet2?action=emailVrf&tnt_email="+tnt_email+"&code="+tnt_acc;
				MailService mailService = new MailService();

//				System.out.println(emailVrfLink);
				// 記得要改!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
