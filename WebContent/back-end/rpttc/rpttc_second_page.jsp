										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable">
												...
												<tbody>
													...
													<c:forEach var="rpttcVO" items="${list}"
														...
														<div class="modal fade" id="${rpttcVO.rpttc_no}"
																	...
																	<div class="modal-header">
																		<div class="modal-body">
																			<form action="RpttcServlet" method="post">
																				...
																				<textarea class="reason" name="rpttc_content"
																					readonly>${rpttcVO.rpttc_content}</textarea>
