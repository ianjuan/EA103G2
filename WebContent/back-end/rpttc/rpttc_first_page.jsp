													...
													<form METHOD="post" ACTION="RpttcServlet">
														<h5>
															搜尋: <input type="text" size="27" name="Number"
																placeholder="輸入檢舉/ 評價/ 房客/ 員工編號"> <input
													...
													<tr>
														...
														%><td><form action="RpttcServlet" method="post">
																...
																<input type="hidden" name="rpttc_no"
																	...
																	type="hidden" name="rpttc_status" value="1">
																...
																<div class="modal-header">
																	<div class="modal-body1">
																		...
																		<form action="RpttcServlet" method="post"
																			...
																			<textarea class="reason1" name="rpttc_content"
																				readonly><%=rpttcvo.getRpttc_content()%></textarea>
																		...
																		%><form action="RpttcServlet" method="post" name="detail"
																			...
																			<input type="hidden" name="rpttc_no"
																				...
																				for="reason1">檢舉原因:</label>
																			<textarea class="reason1" name="rpttc_content"
																				readonly style="width: 460px;"><%=rpttcvo.getRpttc_content()%></textarea>
																			<div class="form-group">
																				<label for="note">結果註記:</label>
