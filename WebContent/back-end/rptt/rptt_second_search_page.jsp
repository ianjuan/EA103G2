							...
							<div class="container-fluid">
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<div class="row">
											<div class="col-md">
												<h5 class="m-0 font-weight-bold text-primary">檢舉房客</h5>
											</div>
												...
												<tbody>
													...
													<c:forEach var="rpttVO" items="${list}"
														...
														<tr>
															...
															<td width="12%">${rpttVO.rptt_done_time}</td>
															<td>
																	...
																	<div class="modal-header">
																		<div class="modal-body">
																			<form action="RpttServlet" method="post">
																				...
																				<textarea class="reason" name="rptt_content"
																					readonly>${rpttVO.rptt_content}</textarea>
