				...
				<div class="table-responsive">
					<table class="table table-bordered" id="dataTable">
						...
						<tbody>
							...
							<c:forEach var="rpthcVO" items="${list}" begin="<%=pageIndex%>"
								...
								<div class="modal fade" id="${rpthcVO.rpthc_no}" tabindex="-1"
									role="dialog">
											...
											<div class="modal-header">
												<div class="modal-body">
													<form action="RpthcServlet" method="post">
														...
														<textarea class="reason" name="rpthc_content" readonly>${rpthcVO.rpthc_content}</textarea>
