													...
													<tr>
														...
														%><td><form action="RpthcServlet" method="post">
																...
																<input type="hidden" name="rpthc_no"
																	...
																	type="hidden" name="rpthc_status" value="1">
																...
																<div class="modal-header">
																	<div class="modal-body1">
																		...
																		<form action="RpthcServlet" method="post"
																			...
																			<textarea class="reason1" name="rpthc_content"
																				readonly><%=rpthcvo.getRpthc_content()%></textarea>
																		...
																		%><form action="RpthcServlet" method="post"
																			...
																			<input type="hidden" name="rpthc_no"
																				value="<%=rpthcvo.getRpthc_no()%>"> <input
																				type="hidden" name="hcm_no"
																				value="<%=rpthcvo.getHcm_no()%>"><label
																				for="reason1">檢舉原因:</label>
																			<textarea class="reason1" name="rpthc_content"
																				readonly style="width: 460px;"><%=rpthcvo.getRpthc_content()%></textarea>
																			<div class="form-group">
																				<label for="note">結果註記:</label>
