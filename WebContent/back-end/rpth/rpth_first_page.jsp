													...
													<tr>
														...
														%><td><form action="RpthServlet" method="post">
																...
																<input type="hidden" name="rpth_no"
																	...
																	type="hidden" name="rpth_status" value="1">
																...
																<div class="modal-header">
																	<div class="modal-body1">
																		...
																		<form action="RpthServlet" method="post" name="detail"
																			...
																			<textarea class="reason1" name="rpth_content"
																				readonly><%=rpthvo.getRpth_content()%></textarea>
																		...
																		%><form action="RpthServlet" method="post"
																			...
																			<input type="hidden" name="rpth_no"
																				...
																				for="reason1">檢舉原因:</label>
																			<textarea class="reason1" name="rpth_content"
																				readonly style="width: 460px;"><%=rpthvo.getRpth_content()%></textarea>
																			<div class="form-group">
																				<label for="note">結果註記:</label>
