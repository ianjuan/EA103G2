...
<%
	...
	List<RpthVO> list = rpthSvc.getAllRpth();
													...
													<form METHOD="post" ACTION="RpthServlet">
														<h5>
															搜尋: <input type="text" size="27" name="Number"
																placeholder="輸入檢舉/ 房屋/ 房客/ 員工編號"> <input
										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable">
												...
												<tbody>
													...
													<c:forEach var="rpthVO" items="${list}"
														...
														<div class="modal fade" id="${rpthVO.rpth_no}"
																	...
																	<div class="modal-header">
																		<div class="modal-body">
																			<form action="RpthServlet" method="post">
																				...
																				<textarea class="reason" name="rpth_content"
																					readonly>${rpthVO.rpth_content}</textarea>
