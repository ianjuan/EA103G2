...
<%
	...
	List<RptrVO> rptrVO = (List<RptrVO>) pageContext.getAttribute("rptrVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
													...
													<tr>
														...
														%><td><form action="RptrServlet" method="post">
																...
																<input type="hidden" name="rptr_no"
																	...
																	type="hidden" name="rptr_status" value="1">
																...
																<div class="modal-header">
																	<div class="modal-body1">
																		...
																		<form action="RptrServlet" method="post" name="detail"
																			...
																			<textarea class="reason1" name="rptr_content"
																				readonly><%=rptrvo.getRptr_content()%></textarea>
																		...
																		%><form action="RptrServlet" method="post"
																			...
																			<input type="hidden" name="rptr_no"
																				value="<%=rptrvo.getRptr_no()%>"> <input
																				type="hidden" name="rep_no"
																				value="<%=rptrvo.getRep_no()%>"><label
																				for="reason1">檢舉原因:</label>
																			<textarea class="reason1" name="rptr_content"
																				readonly style="width: 460px;"><%=rptrvo.getRptr_content()%></textarea>
																			<div class="form-group">
																				<label for="note">結果註記:</label>
