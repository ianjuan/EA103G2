							...
							<form METHOD="post" ACTION="RptrServlet">
								<h4>
									搜尋: <input type="text" size="27" name="Number"
										placeholder="輸入檢舉/ 檢舉/ 房客/ 員工編號"> <input type="hidden"
				...
				<div class="table-responsive">
					<table class="table table-bordered" id="dataTable">
						...
						<tbody>
							...
							<c:forEach var="rptrVO" items="${list}" begin="<%=pageIndex%>"
								...
								<div class="modal fade" id="${rptrVO.rptr_no}" tabindex="-1"
									role="dialog">
											...
											<div class="modal-header">
												<div class="modal-body">
													<form action="RptrServlet" method="post">
														...
														<textarea class="reason" name="rptr_content" readonly>${rptrVO.rptr_content}</textarea>
