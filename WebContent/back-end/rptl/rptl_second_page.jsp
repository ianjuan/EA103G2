										...
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable">
												...
												<tbody>
													...
													<c:forEach var="rptlVO" items="${list}"
														...
														<tr>
															...
															<td width="12%">${rptlVO.rptl_done_time}</td>
															<td>
																<button class="check" data-toggle="modal"
																	data-target="#${rptlVO.rptl_no}">查看詳情</button>
															</td>
														</tr>
														<div class="modal fade" id="${rptlVO.rptl_no}"
																	...
																	<div class="modal-header">
																		<div class="modal-body">
																			<form action="RptlServlet" method="post">
																				...
																				<textarea class="reason" name="rptl_content"
																					readonly>${rptlVO.rptl_content}</textarea>
