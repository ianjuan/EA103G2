...
<%
	...
	List<RptlVO> list = rptlSvc.getAllRptl();
			...
			<li class="nav-item"><a class="nav-link collapsed" href=""
				...
				<div id="collapseTwoooo" class="collapse" aria-labelledby="headingTwoooo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rptl/rptl_main_page.jsp">檢舉房東</a>
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rptt/rptt_main_page.jsp">檢舉房客</a> 
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rpth/rpth_main_page.jsp">檢舉房屋</a>
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rptlc/rptlc_main_page.jsp">檢舉房東評價</a>
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rpttc/rpttc_main_page.jsp">檢舉房客評價</a>
					    <a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rpthc/rpthc_main_page.jsp">檢舉房屋評價</a>
						<a class="collapse-item" href="<%=request.getContextPath()%>/back-end/rptr/rptr_main_page.jsp">檢舉修繕</a>
<!-- 						<a	class="collapse-item" href="javascript:void(0)">新增員工</a> -->
					</div>
				</div>
			</li>
