...
<%
	...
	List<RptlcVO> rptlcVO = (List<RptlcVO>) pageContext.getAttribute("rptlcVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
							...
							<tr>
								...
								%><td><form action="RptlcServlet" method="post">
										...
										<input type="hidden" name="emp_no"
											...
											type="hidden" name="rptlc_no" value="<%=rptlcvo.getRptlc_no()%>">
										<input type="hidden" name="rptlc_status" value="1">
									...
									<div class="modal-content">
										<div class="modal-header">
											<div class="modal-body1">
												...
												%>
												<form action="RptlcServlet" method="post" name="detail"
													id="detail">
													...
													<textarea class="reason1" name="rptlc_content" readonly><%=rptlcvo.getRptlc_content()%></textarea>
												...
												%><form action="RptlcServlet" method="post" name="detail"
													...
													<input type="hidden" name="rptlc_no"
														value="<%=rptlcvo.getRptlc_no()%>"> <input
														type="hidden" name="lcm_no"
														value="<%=rptlcvo.getLcm_no()%>"><label
														for="reason1">檢舉原因:</label>
													<textarea class="reason1" name="rptlc_content" readonly
														style="width: 460px;"><%=rptlcvo.getRptlc_content()%></textarea>
													<div class="form-group">
														<label for="note">結果註記:</label>
