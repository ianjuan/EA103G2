				...
				<div class="table-responsive">
					<table class="table table-bordered" id="dataTable">
						...
						<tbody>
							...
							<c:forEach var="rptlcVO" items="${list}" begin="<%=pageIndex%>"
								...
								<div class="modal fade" id="${rptlcVO.rptlc_no}" tabindex="-1"
									role="dialog">
											...
											<div class="modal-header">
												<div class="modal-body">
													<form action="RptlcServlet" method="post">
														...
														<textarea class="reason" name="rptlc_content" readonly>${rptlcVO.rptlc_content}</textarea>
