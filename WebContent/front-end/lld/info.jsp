...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/front-end/lld/css/info_lld.css">
    <!--===============================================================================================-->
                            ...
                            <div data-v-9403d44c="" class="bg-white info-form-wrap px-lg-5 px-md-4 px-3 pt-md-5 pt-4 mb-md-7 mb-4">
                                ...
                                <form class="registerform" enctype="multipart/form-data">
                                    <div class="wrap-register100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                        <input class="register100" type="text" name="lld_email" id="lld_email" value="${lldVO.lld_email}" readonly>
                                    ...
                                    <div class="wrap-register100 validate-input" data-validate="Must be between 2-19 characters">
                                        <input class="register100" type="text" name="lld_name" id="lld_name" value="${lldVO.lld_name}">
                                        <span class="focus-register100"></span>
                                        <span class="label-register100">姓名</span>
                                    </div>
                                    <select class="wrap-register100 validate-input" data-validate="Gender is required" name="lld_sex" id="lld_sex" >
                                        <span class="focus-register100"></span>
                                        <span class="label-register100">
                                            <option value="">選擇性別
                          					  <option value="true" ${(lldVO.lld_sex)?'selected':''}>男
											  <option value="false" ${(lldVO.lld_sex)?'':'selected'}>女
                                        </span>
                                    </select>
                                    <div class="wrap-register100 validate-input" data-validate="Valid ID is required">
                                        <input class="register100" type="text" name="lld_id" id="lld_id" value="${lldVO.lld_id}">
                                        <span class="focus-register100"></span>
                                        <span class="label-register100">身分證號碼</span>
                                    </div>
                                    <div class="wrap-register100 validate-input" data-validate="Mobile is required">
                                        <input class="register100" type="text" name="lld_mobile" id="lld_mobile" value="${lldVO.lld_mobile}">
                                        <span class="focus-register100"></span>
                                    ...
                                    <select class="wrap-register100 validate-input" data-validate="City is required" name="lld_city" id="lld_city">
                                        <span class="focus-register100"></span>
                                        <span class="label-register100">
...
<%--                        					 </c:if> --%>
                                    ...
                                    <select class="wrap-register100 validate-input" data-validate="District is required" name="lld_dist" id="lld_dist">
...
<%--                        					</c:if> --%>
                                    ...
                                    <div class="wrap-register100 validate-input" data-validate="Address is required">
                                        <input class="register100" type="text" name="lld_add" id="lld_add" value="${lldVO.lld_add}">
                                        <span class="focus-register100"></span>
                                        ...
                                        <div class="wrapperBackground">
                                            <div id=wrapperUploadHandler ondrop="dropUploadHandler(event)">
                                                <label id="fileInput" for="inputF">
                                                    <input ondrop="dropUploadHandler(event)" type="file" id="inputF" name="lld_pic"> Upload your photo
                                                </label>
                            ...
                            <div data-v-9403d44c="" class="bg-white info-form-wrap px-lg-5 px-md-4 px-3 pt-md-5 pt-4 mb-md-7 mb-4">
                                ...
                                <form class="registerform" enctype="multipart/form-data">
                                    ...
                                    <div class="wrap-register100 validate-input" data-validate="Less than 8 [a-zA-Z0-9]">
                                        <input class="register100" type="password" name="lld_pwd_new" id="lld_pwd_new">
                                        <span class="focus-register100"></span>
                                        <span class="label-register100">新密碼</span>
                                    </div>
                                    <div class="wrap-register100 validate-input" data-validate="Password is not the same">
                                        <input class="register100" type="password" name="lld_pwd_new2" id="lld_pwd_new2">
    ...
    <!--===============================================================================================-->
    <script src="<%=request.getContextPath()%>/front-end/lld/js/info_lld.js"></script>
    <!--===============================================================================================-->
    <script>
    //------------------大吳datetimepicker--------------------
...
//     var birthdaydefault = (${(lldVO.lld_birth)!=null})? ${lldVO.lld_birth}:somedate3; //壞的
//     console.log(birthdaydefault);
    ...
    $('#f_date1').datetimepicker({
        ...
        value:'${lldVO.lld_birth}',  //somedate3
        // value: new Date(),
