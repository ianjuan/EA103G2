...
<%-- 以下等同第8行--%>
<jsp:useBean id="list" scope="session" type="java.util.List<Con_aplVO>" />

<html>
<head>
<title>所有租屋申請資料 - listAllCon_apl2_getFromSession.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有租屋申請資料 - listAllCon_apl2_getFromSession.jsp</h3>
