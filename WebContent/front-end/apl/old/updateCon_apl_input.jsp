...
<title>租屋申請資料修改 - updateCon_apl_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>租屋申請修改 - updateCon_apl_input.jsp</h3>
...
<table>
	<tr>
		<td>租屋申請編號:<font color=red><b>*</b></font></td>
		<td><%=con_aplVO.getApl_no()%></td>
	</tr>
	
	<tr>
		<td>房客編號:</td>
		<td><input type="TEXT" name="tnt_no" size="45" value="<%=con_aplVO.getTnt_no()%>" /></td>
	</tr>
	<tr>
	
	<tr>
		<td>房屋編號:</td>
		<td><input type="TEXT" name="hos_no" size="45" value="<%=con_aplVO.getHos_no()%>" /></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=con_aplVO.getApl_time()%>', // value:   new Date(),
