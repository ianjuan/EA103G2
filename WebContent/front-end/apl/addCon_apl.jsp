...
<title>租屋申請新增 - addCon_apl.jsp</title>
...
<body bgcolor='white'>
	...
	<FORM METHOD="post"
		ACTION="<%=request.getContextPath()%>/apl/Con_aplServlet" name="form1">
		<table>
			<tr>
				<td>房客編號:</td>
				<td><input type="TEXT" name="tnt_no" size="45"
					value="<%=(con_aplVO == null) ? "TNT000001" : con_aplVO.getTnt_no()%>" /></td>
			</tr>
			<tr>
				<td>房屋編號:</td>
				<td><input type="TEXT" name="hos_no" size="45"
					value="<%=(con_aplVO == null) ? "HOS000001" : con_aplVO.getHos_no()%>" /></td>
			</tr>
			<tr>
				<td>申請日期:</td>
				<td><input name="apl_time" id="f_date1" type="text"></td>
			</tr>
			<tr>
				<td>租屋開始時間:</td>
			...
			<jsp:useBean id="con_aplSvc" scope="page"
				class="com.apl.model.Con_aplService" />
				<tr>
...
java.sql.Date apl_time = null;
	try {
		apl_time = con_aplVO.getApl_time();
	} catch (Exception e) {
