...
<body>	
	<div class="container">		
		<form autocomplete="off" METHOD="post" ACTION="<%=request.getContextPath()%>/house_manage/HouseServlet">
			<span id="notice">請輸入房東編號 :</span>
			<div class="finder">
				<div class="finder__outer">
					<div class="finder__inner">
						<div class="finder__icon" ref="icon"></div>						
						<input class="finder__input" type="text" name="lld_no" value="LLD000001"/>
						<input type="hidden" name="action" value="getLldAllHouse">
						<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.2.6/gsap.min.js"></script>
						<div>
							<button class="black noselect" type="submit">我的房屋</button>
						</div>
					</div>
				</div>
			</div>
