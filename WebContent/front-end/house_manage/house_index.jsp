	...
	<div id="body">
		...
		<div id="center">
			...
			<div class="houseinfo">
				...
				<div class="rinfo">
					<button type="button" class="link"><a href="<%=request.getContextPath()%>/front-end/house_manage/house_rent.jsp">查看清單</a></button>
				</div>
			</div>
			<div class="houseinfo">
				<div class="linfo">
				...
				<div class="rinfo">
					<button type="button" class="link"><a href="<%=request.getContextPath()%>/front-end/house_manage/house_unrent.jsp">查看清單</a></button>
				</div>
			</div>
			<div class="houseinfo">
				<div class="linfo">
				...
				<div class="rinfo">
					<button type="button" class="link"><a href="<%=request.getContextPath()%>/front-end/house_manage/house_off.jsp">查看清單</a></button>
				</div>
			</div>
			<div class="houseinfo">
				<div class="linfo">
