...
<%
	...
	List<HouseVO> list = houseSvc.getLldOffHouse(lld_no);
...
<body>
	...
	<div id="body">
		<div id="left">
			<nav id="housenav">
				...
				<div class="nav-links">
					...
					<a href="<%=request.getContextPath()%>/front-end/house_manage/house_off.jsp" class="link" style="color: #D37707;">下架房屋</a>
		...
		<div id="center">
			<h3 class="houselisttitle">下架房屋</h3><hr>
