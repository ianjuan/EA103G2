...
<!--                                         <div class="wrapperBackground"> -->
<!--                                             <div class="wrapperUploadHandler" id=wrapperUploadHandler ondrop="dropUploadHandler_IDpicb(event)"> -->
<!--                                                 <label id="fileInput_IDpicb" for="inputF_IDpicb"> -->
<!--                                                     <input ondrop="dropUploadHandler_IDpicb(event)" type="file" id="inputF_IDpicb" name="tnt_id_picf" multiple> Upload Files -->
<!--                                                 </label> -->
<!--                                                 <button type="button" class="delclass" id="del_IDpicb" ondrop="dropUploadHandler_IDpicb(event)">Delete</button> -->
<!--                                             </div> -->
<!--                                         </div> -->
<!--                                         <div id="picWrapper_IDpicb"> -->
<!--                                             <div class="grid" id="grid"> -->
<!--                                             </div> -->
<!--                                         </div> -->
<!--                                 </form> -->
