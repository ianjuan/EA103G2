...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="css/info_tnt.css">
                    ...
                    <div class="col-xl-8 col-lg-9 pl-xl-0 pl-lg-7 offset-lg-0 basicInfo__nuxt">
                        <div data-v-9403d44c="" class="basicInfo__info">
                            ...
                            <div data-v-9403d44c="" class="bg-white info-form-wrap px-lg-5 px-md-4 px-3 pt-md-5 pt-4 mb-md-7 mb-4">
                                <h2 data-v-9403d44c="" class="font-size-lg text-center p-b-10 mb-0">
                                    基本資訊
                                    <a data-v-9403d44c="" class="pr-md-3 float-right" id="angle-down-up">
                                ...
                                <form id="registerform" enctype="multipart/form-data">
                                    ...
                                    <div class="container-login100-form-btn">
                                        <button class="login100-form-btn m-t-16 infoBtn" id="btnProfile">儲存資訊</button>
                                    </div>
                            </div>
                            <div id="divPic">
